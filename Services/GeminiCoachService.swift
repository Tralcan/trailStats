...
struct GeminiCoachService {
    ...
    static func fetchObservation(kpis: [String: String], completion: @escaping (Result<String, Error>) -> Void) {
        ...
        Comienza con tus hallazgos clave sobre el rendimiento, seguidos de tus sugerencias para mejorar. Basa tu análisis únicamente en los datos proporcionados.
        """
